...
function showCal(name, top, left) 
{
  var d=new Date();
  ...
  if (currentCal != null) 
    ...
    if (isIE) 
    {
      layers[cal].style.pixelTop=top;
      layers[cal].style.pixelLeft=left;
      layers[cal].style.zIndex=2;
      layers[cal].innerHTML=calendar;
    ...
    {
	    alert("Calendar - unknown browser");
    }
  }
  else 
	{
