<?php
// displays members only header
?>
<p>&nbsp;
  <div align="center">
    <center>
      <table border="0" cellpadding="0" cellspacing="0" width="90%" bgcolor="#FFFFFF" bordercolor="#000099">
        <tr>
          <td>
            <!-- <table border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td><img border="0" src="<?php if (isset($DirOffset)) echo $DirOffset; ?>images/spacer.gif" width="1" height="10"></td></tr></table> -->
            <div align="center">
              <center>
            ...
            <div align="center">
              <center>
                <table border="0" cellpadding="0" cellspacing="0" width="95%">
                  ...
                  <tr>
                    <td width="25%" nowrap valign="top" align="left">