<?php
// footer for credit card join.php etc scripts
?>
</td>
</tr>
<tr>
    ...
    <table border="0" cellpadding="4" cellspacing="4" width="95%" style="border-collapse: collapse" bordercolor="#111111">
      <tr>
        <td width="100%" style="text-align: center">
          <br>&nbsp;
          Software by <a href="http://www.abeleweb.com" target="__blank">AdventureClub.Info</a> |
...
<div align="center">
  <center>
    <table border="0" cellpadding="8" cellspacing="8" style="border-collapse: collapse" bordercolor="#111111" id="AutoNumber15">
      <tr>
        <td><a href="/policies.php" target="__blank">
            Policies</a></td>
        <td><a href="/liabilityrelease.pdf" target="__blank">
            Liability Waiver</a></td>
        <td>Version <?php echo WebsiteVersionNumber(); ?></td>
